...
public class InitClient {
    ...
    static final String CLIENT1_KEY_PATH = "crypto-config2/TestCMorg1/user/示例测试用户1/示例测试用户1.sign.key";
    static final String CLIENT1_CERT_PATH = "crypto-config2/TestCMorg1/user/示例测试用户1/示例测试用户1.sign.crt";

    static String CLIENT1_TLS_KEY_PATH = "crypto-config2/TestCMorg1/user/示例测试用户1/示例测试用户1.tls.key";
    static String CLIENT1_TLS_CERT_PATH = "crypto-config2/TestCMorg1/user/示例测试用户1/示例测试用户1.tls.crt";

    static final String ORG_ID1 = "TestCMorg1";

    static String SDK_CONFIG = "sdk_config2.yml";
